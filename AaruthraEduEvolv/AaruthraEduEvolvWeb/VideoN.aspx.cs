...
public partial class VideoN : System.Web.UI.Page
{
            ...
            foreach (var course in cs.Courses)
            {
                for (int i = 0; i < course.Materials.Count; i++)
                {
                    if (course.Materials[i].MaterialID == MaterialID)
                    {
                        ...
                        player.Attributes.Add("value", "https://vimeo.com/moogaloop.swf?clip_id=136797006&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1".Replace("136797006",course.Materials[i].VideoURL.Substring(31)));
                        playerembed.Attributes.Add("src", "https://vimeo.com/moogaloop.swf?clip_id=136797006&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1".Replace("136797006", course.Materials[i].VideoURL.Substring(31)));
