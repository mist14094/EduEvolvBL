<%@ Page Language="C#" AutoEventWireup="true" Inherits="TestYourOralSkill" CodeBehind="TestYourOralSkill.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row hidden" id="lenscap-promo">
                <strong>
                    <div class="alert text-center" role="alert" id="header" runat="server">
                        Title of the video
        ...
        <asp:Label ID="lblstrQuestion" runat="server" Text='<%#string.Concat(" " ,Eval("strQuestion")) %>' />
                                                <a href='<%#Eval("strQuestionAL").ToString().Substring(22,Eval("strQuestionAL").ToString().IndexOf(".mp3", System.StringComparison.Ordinal)+4-22) %>' class="sm2_button">Question</a>
                                            </b>
                                            <%-- <asp:Label ID="lblstrQuestionDescription" runat="server" Text='<%# string.Concat(" <br/>" ,Eval("strQuestionDescription")) %>' />--%>
                                           
                                           <%-- <asp:Label ID="lblstrAnswerHint" runat="server" ForeColor="Blue" Text='<%# string.Concat("Choose the Answer from : ",Eval("strAnswerHint")) %>' />
                                          ...
                                          <%--  <asp:TextBox runat="server" ID="txtAnswer" Width="100%" Visible="False"></asp:TextBox>--%>
                                ...
                                <EmptyDataTemplate>
                                    <center>
                                        <h1>No test for this video yet, Stay tuned</h1>
                                        <br />
                                        <br />
                            ...
                            <asp:Button runat="server" ID="btnSubmit" Text="Show Answer" OnClick="btnSubmit_Click"></asp:Button>
