<%@ Page Language="C#" AutoEventWireup="true" Inherits="VideoN" CodeBehind="VideoN.aspx.cs" EnableEventValidation="false" %>
...
<html>
                ...
                <div class="tab-pane fade in active well" id="vimeo">
				  ...
				  <div id="vimeopreview">
				        <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'>
                            ...
                            <%--<iframe runat="server" ID="player" src="https://player.vimeo.com/video/1275552"  player_id="122" frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>--%>
                            
                            <object>
 <param name="allowfullscreen" value="true" />
 <param name="allowscriptaccess" value="always" />
 <param  runat="server" id="player" name="movie" value="https://vimeo.com/moogaloop.swf?clip_id=136797006&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1" />
 <embed  runat="server" id="playerembed" src="https://vimeo.com/moogaloop.swf?clip_id=136797006&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1"
 type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always"></embed>
             ...
             <br/><br/><center>  <a href="https://get.adobe.com/flashplayer/">If plugin is missing, click here to download</a></center> 
                </div>
              </div>
