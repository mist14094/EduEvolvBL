<%@ Page Language="C#" AutoEventWireup="true" Inherits="CourseList" CodeBehind="CourseList.aspx.cs" %>
    ...
    <td id="Td1" valign="top" align="center" style="width:300px;" runat="server">
     ...
     <asp:HyperLink ID="ProductLink" runat="server" Text='<% #Eval("Title")%>'
        ...
        <br /><br />
            ...
            <EmptyDataTemplate>
                 <center> <b>There is no active course set for you, You can buy more course.</b> </center>
            </EmptyDataTemplate>
        </asp:ListView>
