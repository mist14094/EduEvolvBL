<%@ Page Language="C#" AutoEventWireup="true" Inherits="PaymentVerification" CodeBehind="PaymentVerification.aspx.cs" %>
...
<asp:HyperLink ID="hpVerifyPayment" runat="server" style="color: white" Text="Payment Verfication" NavigateUrl="PaymentVerification.aspx"></asp:HyperLink> &nbsp;&nbsp;&nbsp;
    ...
    <div>
        <asp:GridView ID="gvPayments" AutoGenerateColumns="False" GridLines="Horizontal" Width="100%"  runat="server" DataKeyNames="payment_id" onrowcommand="gridMembersList_RowCommand" BackColor="White" BorderColor="#336666" CellSpacing="10" BorderWidth="3px" CellPadding="4"  ><%--AllowPaging="True" PageSize="10"--%>
        <Columns>
