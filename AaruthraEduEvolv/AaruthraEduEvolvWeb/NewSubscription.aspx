<%@ Page Language="C#" AutoEventWireup="true" Inherits="NewSubscription" CodeBehind="NewSubscription.aspx.cs" %>
      ...
      <asp:TemplateField HeaderText="Expiration Date">
        ...
        <ItemTemplate>
            ...
            <EmptyDataTemplate>
                ...
                Add Subscription<br />
        <br />
        Select Plan : <asp:DropDownList runat="server" ID="ddlUserList0" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlUserList_SelectedIndexChanged"/>
        &nbsp;<br />
                <br />
