...
namespace AaruthraEduEvolvBL
{
    public class SendMail
    {
        ...
        public  bool SendMailThread(string strTo, string strSubject, string strText, bool isBodyHtml, string smtpServer, string login, string password, int port, string emailFrom, bool ssl)
        {
        ...
        public  bool SendMailNow(string strTo, string strSubject, string strText, bool isBodyHtml, string setSmtpServer, int setPort, string setLogin, string setPassword, string setEmailFrom, bool setSsl)
        {
        ...
        public  bool SendMailNow(string strTo, string strSubject, string strText, bool isBodyHtml)
        {
        ...
        public string BuildMail(DataSet ds, string MailType,string domain)
        {
